...
export function PostWrapper({ children , title , seo_title , description , image , slug  }) {
    ...
    return [
        ...
        h(Layout, null, h("header", {
            ...
            title: 'Do more of what matters.'
        }, h("p", null, "I’ve spent a lot of my life doing things the hard way. I write about the experiences, experiments, and strategies that have helped me live a happier, more fulfilling life where I’m able to do more of what matters to me — and less of what doesn’t."), h("p", null, "Join my newsletter and I’ll share those stories directly to your inbox.")))), 
    ];
}
